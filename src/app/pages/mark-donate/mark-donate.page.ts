...
@Component({
  selector: 'app-mark-donate',
  templateUrl: './mark-donate.page.html',
  styleUrls: ['./mark-donate.page.scss'],
})
export class MarkDonatePage implements OnInit {
...
this.loadingCtrl.dismiss();
  ...
  async add() {
    ...
    this.msg = this.feedbackForm.get('msg').value,
      ...
      this.authservice.feedback_donor(this.request_id, this.rating, this.msg,this.capturedSnapURL).subscribe((data) => {
