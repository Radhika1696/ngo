...
@Component({
  selector: 'app-mark-receiver-feedback',
  templateUrl: './mark-receiver-feedback.page.html',
  styleUrls: ['./mark-receiver-feedback.page.scss'],
})
export class MarkReceiverFeedbackPage implements OnInit {
  ...
  async add() {
    ...
    this.msg = this.feedbackForm.get('msg').value,
      ...
      this.authservice.feedback_receiverlist(this.request_id, this.rating, this.msg, this.capturedSnapURL).subscribe((data) => {
  ...
  //   this.ans=this.temparray.push(temp)
