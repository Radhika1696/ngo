...
@Component({
  ...
  templateUrl: './notification-receiver.page.html',
  styleUrls: ['./notification-receiver.page.scss'],
})

export class NotificationReceiverPage implements OnInit {
  ...
  ngOnInit() {
    this.navCtrl.navigateForward(`marked-receiver-notification/${this.id}`)
  }
