...
@Component({
  selector: 'app-marked-receiver',
  templateUrl: './marked-receiver.page.html',
  styleUrls: ['./marked-receiver.page.scss'],
})
export class MarkedReceiverPage implements OnInit {
  ...
  async add() {
    ...
    this.msg = this.feedbackForm.get('msg').value,
      ...
      this.authservice.feedback_receiver(this.request_id, this.rating, this.msg,this.capturedSnapURL).subscribe((data) => {
